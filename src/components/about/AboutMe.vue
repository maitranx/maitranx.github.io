            ...
            <Tabs>
                <Tab title="Lifestyle">
                    <div class="flex flex-col md:flex-row">
                        ...
                        <div class="md:w-3/5 mr-8">
                            <div class="h-48 flex-col justify-start items-start flex">
                                ...
                                <div class="text-white text-5xl font-medium md:w-2/3 text-left leading-relaxed">Fulfilling & diverse lifestyle</div>
                            </div>
                                    ...
                                    <div class="justify-start items-start gap-6 inline-flex">
                                        ...
                                        >
                                            ...
                                            <div>
                                                ...
                                                ><span class="text-sky-300 text-xl font-normal leading-loose">for Fun</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="text-neutral-400 text-base font-normal font-['Poppins'] leading-tight">with professional role in</div>
                                    <div class="self-stretch h-36 p-6 bg-neutral-900 rounded-2xl flex-col justify-between items-start flex">
                    ...
                    <div class="w-full flex-col justify-start items-start gap-6 inline-flex mt-12">
                        ...
                        <div class="w-3/5 p-6 bg-neutral-900 rounded-2xl flex-col justify-start items-start gap-4 flex text-primary-light">
                            <div class="self-stretch flex-col justify-start items-start flex">
                                ...
                                <div class="self-stretch py-4 border-t border-dashed border-neutral-500 justify-between items-center inline-flex">
                                    <div class="justify-start items-center gap-2 flex">
                                        ...
                                        <div class="flex-col justify-center items-start gap-1 inline-flex">
                                            <div class="h-5 justify-start items-center gap-2 inline-flex">
                                                <div class="text-white text-base font-normal font-['Poppins'] leading-tight">Aperia</div>
                                                <div class="text-neutral-400">|</div>
                                                <div class="text-neutral-400 text-base font-normal font-['Poppins'] leading-tight">
                                                    09.2021 - 09.2022
                                                </div>
                                ...
                                <div class="self-stretch pt-4 border-t border-dashed border-neutral-500 justify-between items-center inline-flex">
                                    <div class="justify-start items-center gap-2 flex">
                                        <div class="w-11 h-11 relative">
                                        ...
                                        <div class="flex-col justify-center items-start gap-1 inline-flex">
                                            <div class="h-5 justify-start items-center gap-2 inline-flex">
                                                <div class="text-white text-base font-normal font-['Poppins'] leading-tight">NashTech Global</div>
                                                <div class="text-neutral-400">|</div>
                                                <div class="text-neutral-400 text-base font-normal font-['Poppins'] leading-tight">
                                                    2018 - 08.2021
                                                </div>
