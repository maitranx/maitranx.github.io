...
<template>
    <div class="xl:mt-20">
            <div class="relative px-4 md:px-[84px] xl:px-[168px] w-full">
                <img class="rounded-2xl w-full" :src="blog.banner" />
            </div>
            <div class="text-center text-3xl xl:text-4xl text-primary-dark dark:text-primary-light mt-14 xl:mt-20 mb-20">
                <div class="font-general-regular text-center text-secondary-dark dark:text-slate-400 text-xl xl:text-xl font-n mb-2">my blog</div>
                <div class="px-[24px] md:px-[120px] xl:px-[345px] self-stretch text-center text-white text-2xl xl:text-5xl font-medium leading-[150%]" v-html="blog.title"></div>
