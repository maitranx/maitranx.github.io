...
<template>
    <div class="xl:mt-20">
            ...
            <div class="text-center text-3xl xl:text-4xl text-primary-dark dark:text-primary-light mt-14 xl:mt-20 mb-20">
                <div class="font-general-regular text-center text-secondary-dark dark:text-slate-400 text-md xl:text-xl font-n mb-8">my blog</div>
                <div class="px-[24px] md:px-[120px] xl:px-[345px] self-stretch text-center text-white text-5xl font-medium leading-[72px]" v-html="blog.title"></div>
