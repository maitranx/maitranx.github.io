...
<template>
	<transition name="fade">
		<div v-show="modal" class="font-general-regular fixed inset-0 z-30">
			...
			<div
				v-show="modal"
				class="bg-filter bg-black bg-opacity-80 backdrop-blur-lg fixed inset-0 w-full h-full z-20"
			></div>
			<!-- Modal content -->
			<main
			...
			>
				<transition name="fade-up-down">
					...
					>
						<div
							class="modal max-w-md mx-5 xl:max-w-xl lg:max-w-xl md:max-w-xl bg-primary-light max-h-screen shadow-lg flex-row rounded-lg relative"
						>
							<div
							...
							<div class="modal-body p-5 w-full h-full">
								<form class="max-w-xl m-4 text-left" onsubmit="return false;">
									<div class="mt-0">
										<input
											class="w-full px-5 py-2 border-1 border-gray-200 dark:border-secondary-dark rounded-md text-md bg-secondary-light text-primary-dark"
											id="key"
											name="key"
											type="password"
											required="true"
